...
from [PyPI](https://pypi.org/project/hyprshade/) with [pipx](https://pypa.github.io/pipx/):
...
>
> Add the following line to `hyprland.conf`[^1]:
>
> ```hypr
> exec-once = dbus-update-activation-environment --systemd HYPRLAND_INSTANCE_SIGNATURE
> ```
>
> [^1]: See also: [Hyprland FAQ][hyprland-faq-import-env] ([archive][hyprland-faq-import-env-archive])
