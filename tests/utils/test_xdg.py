...
from hyprshade.utils.xdg import user_config_dir, user_state_dir
...
class TestUserStateDir:
    def test_uses_xdg_config_home(
        ...
        monkeypatch.setenv("XDG_STATE_HOME", tmp_path.as_posix())
        assert user_state_dir("hyprshade") == (tmp_path / "hyprshade").as_posix()
    ...
    def test_uses_home(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
        ...
        assert (
            ...
            == (tmp_path / ".local/state/hyprshade").as_posix()
        )
